...
#define DEFAULT_CONFIG "conf/miniupnpd.conf"
#endif
...
init(int argc, char * * argv, struct runtime_vars * v)
{
	...
	{
		printf("No MAC address found.  Falling back to generic UUID\n" );
		strcpy(mac_str, "554e4b4e4f57");
	}
	strcpy(uuidvalue_igd+5, "4d696e69-444c-164e-9d41-");
	strncat(uuidvalue_igd, mac_str, 12);
	...
	else
	{
		for(i=0; i<(int)num_options; i++)
		{
			...
			case UPNPFRIENDLY_NAME:
				...
				break;
			case MY_UPNPFRIENDLY_NAME:
				my_friendly_name[0] = '\0';
				break;
